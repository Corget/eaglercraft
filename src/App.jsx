...
import { Download, Play, Menu, Home as HomeIcon, FileText } from 'lucide-react';
      ...
      <footer className="bg-card text-muted-foreground py-6 border-t border-border mt-auto">
        <div className="container mx-auto px-4 text-center">
          <div className="flex justify-center items-center space-x-3 mb-2">
            <p>Eaglercraft - Play Minecraft in your browser</p>
            <a href="https://www.reddit.com/r/EaglercraftNEW/" target="_blank" rel="noopener noreferrer" aria-label="Eaglercraft Reddit Community" className="text-muted-foreground hover:text-primary transition-colors">
              <RedditIcon className="h-5 w-5 fill-current" />
            </a>
            <a href="https://discord.gg/zVgv5hSNY2" target="_blank" rel="noopener noreferrer" aria-label="Eaglercraft Discord Server" className="text-muted-foreground hover:text-primary transition-colors">
              <DiscordIcon className="h-5 w-5 fill-current" />
            </a>
          </div>
          <p className="text-sm">Not affiliated with Mojang or Microsoft</p>
          <Link to="/dmca" className="text-sm mt-1 hover:text-primary transition-colors inline-flex items-center">
